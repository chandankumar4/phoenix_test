defmodule OpenebsciDashnoardApi.SourceKeyProjectsView do
  use OpenebsciDashnoardApi.Web, :view

  def render("index.json", %{source_key_projects: source_key_projects}) do
    %{data: render_many(source_key_projects, OpenebsciDashnoardApi.SourceKeyProjectsView, "source_key_projects.json")}
  end

  def render("show.json", %{source_key_projects: source_key_projects}) do
    %{data: render_one(source_key_projects, OpenebsciDashnoardApi.SourceKeyProjectsView, "source_key_projects.json")}
  end
